...
![The witness details page for David Roberts showing three statements, each with a "View statement" link and a "Mark as Section 9" link.](/manage-cases/mark-witness-statement-as-section-9/entry-page.png)
...
![The confirmation page with the heading "Confirm that you want to mark statement as Section 9" and a green button to confirm.](/manage-cases/mark-witness-statement-as-section-9/step-1-confirmation.png)
...
![The witness details page showing a green success banner saying "Statement 1 marked as Section 9", a "Section 9" tag next to the witness name, and the statement now showing an "Unmark as Section 9" link.](/manage-cases/mark-witness-statement-as-section-9/step-2-success.png)
...
![The case activity log showing an entry for "Witness statement marked as Section 9" by Rachael Harvey with the witness name David Roberts and statement number 1.](/manage-cases/mark-witness-statement-as-section-9/activity-log.png)
